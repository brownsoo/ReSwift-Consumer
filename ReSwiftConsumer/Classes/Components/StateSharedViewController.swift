...
open class StateSharedViewController<State>: UIViewController, StateShared
    ...
    @available(*, deprecated, message: "Make and use own pageConsumer instead for this in view controller. This will be removed at version 0.5")
    private(set) open var sharedConsumer: StateConsumer<State>?

    public let pageConsumer = StateConsumer<State>()

    @available(*, deprecated, obsoleted: 0.5, message: "This is useless because the sharedConsumer is deprecated.")
